...
import 'package:gillar/src/presentation/view/customer_view/ride_start/layout/widgets/ride_bottom_sheet.dart';
          ...
          content: Column(
            ...
            children: [
             Row(
               mainAxisAlignment:MainAxisAlignment.center,
               children: [
                 Text("Arrived!",style:FrontendConfigs.kHeadingStyle,),
               ],
             ),
              const SizedBox(height:8,),
              CustomText(text: "You have arrived  at your destination,\n see you on the next trip :) "),
